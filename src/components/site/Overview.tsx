      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-primary">
            TỔNG QUAN DỰ ÁN MONREI SAIGON
          </h2>
        </div>
        <img
          src={monreiImages.overview}
          alt="Phối cảnh tổng thể Monrei Saigon"
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p>
              <strong className="text-foreground">Monrei Saigon</strong> là dự án phức hợp căn hộ
              cao cấp quy mô <strong>4,46 ha</strong>, kiệt tác kiến trúc định nghĩa lại chuẩn mực
              sống mới tại tâm điểm mặt tiền đường Nguyễn Thị Minh Khai, Thuận An. Với tổng vốn đầu
              tư <strong>18.000 tỷ đồng</strong> — tâm huyết của Mitsubishi Corporation, Tokyu Land
              và Phát Đạt.
            </p>
            <p>
              Khơi nguồn từ định hướng kiến tạo{" "}
              <strong className="text-primary">Urban Hydrotherapy City</strong> đầu tiên tại Việt
              Nam, Monrei Saigon là sự giao thoa giữa kiến trúc thượng lưu và hệ sinh thái trị liệu
              từ nước và thiên nhiên thuần khiết.
            </p>
            <p>
              Mỗi bước chân trở về là một hành trình chạm đến sự tĩnh tại, biến tổ ấm thành một
              "trạm phục hồi" chuyên sâu giữa nhịp sống giao thương sôi động.
            </p>
          </div>
              ...
              <tbody>
                {rows.map(([k, v], i) => (
                  <tr key={k} className={i % 2 ? "bg-secondary/30" : ""}>
                    <td className="px-5 py-3.5 font-semibold text-primary border-r border-border w-1/2 align-top">
                      {k}
                    </td>
